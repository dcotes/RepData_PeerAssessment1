...
```{r, echo=TRUE, fig.width=7, fig.height=7, fig.path='figure_1.png'}
...
Here is the Plot
```{r, echo=TRUE, fig.width=7, fig.height=7, fig.path='figure_2.png'}
...
```{r, echo=TRUE, fig.width=7, fig.height=7, fig.path='figure_3.png'}
...
```{r, echo=TRUE, fig.width=7, fig.height=7, fig.path='figure_4.png'}
